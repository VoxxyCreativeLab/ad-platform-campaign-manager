...
2. **[[skills/CONTEXT|Skills]]** (`skills/`) — 11 interactive guidance tools that load reference docs on demand (campaign setup, keyword strategy, conversion tracking, PMax, reporting, etc.)

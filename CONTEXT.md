...
| iClosed scheduling attribution | `reference/tracking-bridge/iclosed-attribution.md` | `reference/tracking-bridge/n8n-pipeline-patterns.md`, `reference/platforms/meta-ads/capi-server-events.md`, `reference/reporting/cross-platform-data-model.md` | Google Ads tracking-bridge, scripts, mcp |
| n8n tracking pipeline setup | `reference/tracking-bridge/n8n-pipeline-patterns.md` | `reference/tracking-bridge/iclosed-attribution.md`, `reference/platforms/meta-ads/capi-server-events.md` | Scripts, audit |
| Meta CAPI server events | `reference/platforms/meta-ads/capi-server-events.md` | `reference/tracking-bridge/n8n-pipeline-patterns.md`, `reference/tracking-bridge/iclosed-attribution.md` | Tracking-bridge, reporting |
| Klaviyo tracking / email integration | `reference/platforms/klaviyo/klaviyo-fundamentals.md` | `reference/tracking-bridge/sgtm-to-gads.md`, `reference/reporting/bigquery-native-connectors.md`, `reference/platforms/meta-ads/capi-server-events.md` | Scripts, mcp, audit |
| Looker Studio dashboard setup | `reference/reporting/looker-studio.md` | `reference/reporting/bigquery-native-connectors.md`, `reference/reporting/looker-studio-templates.md`, `reference/reporting/gaql-query-templates.md` | Skills, tracking-bridge, mcp |
